    ...
    <center>
      <div className=" fixed fill-[#1F2937] dark:fill-white bottom-5 w-full  ">
        <div className=" shadow-2xl flex justify-center items-center bg-white border-[#F3F4F6]  dark:bg-[#111827] dark:border-[#374151] border  rounded-xl max-w-[24rem] py-3 px-5">
          ...
          <Link href="/">
            <div className="group relative bg-gray-100 dark:bg-[#1F2937] w-[60px] h-[60px] flex justify-center items-center mx-2 rounded-xl cursor-pointer hover:bg-[#3B82F6] dark:hover:bg-[#3B82F6] ">
              <svg
                width="40"
                height="40"
                viewBox="0 0 46 48"
              ...
              <span className="pointer-events-none absolute -top-7 left-0 w-max opacity-0 transition-opacity group-hover:opacity-100">Home </span>
            </div>
          ...
          <Link href="/project">
            <div className="group relative bg-gray-100 dark:bg-[#1F2937]  w-[60px] h-[60px] flex justify-center items-center mx-2 rounded-xl cursor-pointer hover:bg-[#3B82F6] dark:hover:bg-[#3B82F6]   ">
              ...
              <span className="pointer-events-none absolute -top-7 left-0 w-max opacity-0 transition-opacity group-hover:opacity-100">Projects </span>
            </div>
          </Link>
          <Link href="/about">
            <div className="group relative bg-gray-100 dark:bg-[#1F2937] l w-[60px] h-[60px] flex justify-center items-center mx-2 rounded-xl cursor-pointer hover:bg-[#3B82F6] dark:hover:bg-[#3B82F6] ">
              <img src="Profile.svg" width="40" height="40" />
              <span className="pointer-events-none absolute -top-7 left-0 w-max opacity-0 transition-opacity group-hover:opacity-100">About Me </span>
            </div>
          </Link>
